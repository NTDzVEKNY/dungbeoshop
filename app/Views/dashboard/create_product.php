                        ...
                        <div class="row">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <textarea name="description" class="form-control ps-5 text-dark"
                                                  placeholder="Nhập mô tả" cols="30" rows="5"></textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input required name="stock" type="text"
                                    ...
                                    <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                                        <div class="product-upload">
                                            <label for="file-upload" class="file-upload mb-0">
                                                <img id="output" >
<span id="spanI" class="d-inline-block wh-110 bg-body-bg rounded-10 position-relative ">
...
<i class="ri-camera-line wh-38 bg-gray-div7 d-inline-block text-gray-light rounded-circle position-absolute bottom-0 end-0"
   style="right: -10px !important; bottom: -10px !important;"></i>
                                            ...
                                            <input accept="image/*" name="image" id="file-upload" type="file" onchange="loadFile(event)">
                                        </div>
                                    </div>
                                </div>
                            </div>
